...
},{"./runtime":"N3q+"}],"PMvg":[function(require,module,exports) {
module.exports=require("regenerator-runtime");
},{"regenerator-runtime":"Vdat"}],"agGE":[function(require,module,exports) {
...
},{"./_shared":"NB7d","./_uid":"X6va"}],"HHE0":[function(require,module,exports) {
var t=require("./_has"),e=require("./_to-object"),o=require("./_shared-key")("IE_PROTO"),r=Object.prototype;module.exports=Object.getPrototypeOf||function(c){return c=e(c),t(c,o)?c[o]:"function"==typeof c.constructor&&c instanceof c.constructor?c.constructor.prototype:c instanceof Object?r:null};
},{"./_has":"yS17","./_to-object":"mbLO","./_shared-key":"/wuY"}],"g31e":[function(require,module,exports) {
...
},{"core-js/library/fn/object/get-prototype-of":"ky2m"}],"dACh":[function(require,module,exports) {
...
},{"../core-js/object/define-property":"FFZn"}],"MpYs":[function(require,module,exports) {
...
},{"./_to-iobject":"Wyka","./_to-length":"S7IM","./_to-absolute-index":"Zwq5"}],"B9Lq":[function(require,module,exports) {
...
},{"./_object-create":"TNJq","./_property-desc":"0WCH","./_set-to-string-tag":"11Ut","./_hide":"akPY","./_wks":"Ug9I"}],"uRfg":[function(require,module,exports) {
...
},{"../core-js/object/set-prototype-of":"Aq8W","../core-js/object/create":"yeEC","../helpers/typeof":"GyB/"}],"2JJl":[function(require,module,exports) {
...
},{}],"ScGw":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("babel-runtime/core-js/object/get-prototype-of"),t=d(e),r=require("babel-runtime/helpers/classCallCheck"),o=d(r),n=require("babel-runtime/helpers/createClass"),u=d(n),s=require("babel-runtime/helpers/possibleConstructorReturn"),i=d(s),l=require("babel-runtime/helpers/inherits"),c=d(l),a=require("eventemitter3"),f=d(a);function d(e){return e&&e.__esModule?e:{default:e}}var p=function(e){function r(e,n,u){(0,o.default)(this,r);var s=(0,i.default)(this,(r.__proto__||(0,t.default)(r)).call(this));return s.socket=new window.WebSocket(e,u),s.socket.onopen=function(){return s.emit("open")},s.socket.onmessage=function(e){return s.emit("message",e.data)},s.socket.onerror=function(e){return s.emit("error",e)},s.socket.onclose=function(){return s.emit("close")},s}return(0,c.default)(r,e),(0,u.default)(r,[{key:"send",value:function(e,t,r){r=r||t;try{this.socket.send(e),r()}catch(o){r(o)}}},{key:"close",value:function(e,t){this.socket.close(e,t)}}]),r}(f.default);exports.default=p,module.exports=exports.default;
},{"babel-runtime/core-js/object/get-prototype-of":"BX4+","babel-runtime/helpers/classCallCheck":"dACh","babel-runtime/helpers/createClass":"jx4H","babel-runtime/helpers/possibleConstructorReturn":"VOrx","babel-runtime/helpers/inherits":"ZKjc","eventemitter3":"2JJl"}],"PDcB":[function(require,module,exports) {
...
module.exports=require("regenerator-runtime");
},{"regenerator-runtime":"QYzI"}],"ZHvQ":[function(require,module,exports) {
...
},{"core-js/library/fn/json/stringify":"Q17y"}],"6IAg":[function(require,module,exports) {
...
},{"./debug":"y5CM","process":"pBGv"}],"L0+K":[function(require,module,exports) {
function n(n){return null!=n}module.exports=n;
},{}],"BgQ6":[function(require,module,exports) {
var e=require("./exists");function r(r){return"object"==typeof r&&e(r)&&!Array.isArray(r)&&!(r instanceof RegExp)&&!(r instanceof String)&&!(r instanceof Number)}module.exports=r;
},{"./exists":"L0+K"}],"AhE4":[function(require,module,exports) {
function n(n){return"function"==typeof n}module.exports=n;
},{}],"bLWM":[function(require,module,exports) {
var n=require("./is-function");function r(t){return n(t)?function(){return r(t.apply(this,arguments))}:!t}module.exports=r;
},{"./is-function":"AhE4"}],"uDbN":[function(require,module,exports) {
function t(t){return/^\[.+\]$/.test(t)}module.exports=t;
},{}],"Ddvm":[function(require,module,exports) {
function t(t){return/^[.]{3}.+/.test(t)||/^\[[.]{3}[^\]]+\]$/.test(t)}module.exports=t;
},{}],"tq8x":[function(require,module,exports) {
function e(e){return"number"==typeof e&&isFinite(e)&&Math.floor(e)===e}module.exports=e;
},{}],"rJ7z":[function(require,module,exports) {
function n(n){return"string"==typeof n||n instanceof String}module.exports=n;
},{}],"1RSN":[function(require,module,exports) {
function o(o,r){if(!o)throw new TypeError(r)}module.exports=o;
},{}],"oxev":[function(require,module,exports) {
var t=/^[A-Z]/,e=/^[A-Z]([a-z]|$)/;function r(r,n){return n?e.test(r):t.test(r)}module.exports=r;
},{}],"tvZY":[function(require,module,exports) {
var define;
var t;!function(e){var n=Function.prototype.toString;function o(t){return"function"==typeof t&&(/^class\s/.test(n.call(t))||/^.*classCallCheck\(/.test(function(t){return n.call(t).replace(/^[^{]*{\s*/,"").replace(/\s*}[^}]*$/,"")}(t)))}"undefined"!=typeof exports?("undefined"!=typeof module&&module.exports&&(exports=module.exports=o),exports.isClass=o):"function"==typeof t&&t.amd?t([],function(){return o}):e.isClass=o}(this);
},{}],"3HQQ":[function(require,module,exports) {
var e=require("is-capitalized"),i=require("is-class"),r=require("101/is-function");function u(u){return i(u)||r(u)&&e(u.name)}module.exports=u;
},{"is-capitalized":"oxev","is-class":"tvZY","101/is-function":"AhE4"}],"FM5k":[function(require,module,exports) {
function e(e){return/^[aeiou]/i.test(e)}module.exports=e;
},{}],"+Sjf":[function(require,module,exports) {
!function(){"use strict";var n=function(n){var e={},t="and",i=!1,o=",";return e.endWith=function(n){return"string"!=typeof n?e:(t=n,e)},e.delimitAll=function(){var n=arguments[0];return i="boolean"!=typeof n||n,e},e.delimitWith=function(n){return"string"!=typeof n?e:(o=n,e)},e.make=function(){var e,r,u=i?o+" "+t+" ":" "+t+" ";return void 0===n||!n instanceof Array?"":(e=n.slice(0,-2).join(o+" "),r=n.slice(n.length-2).join(u),e.length?e+o+" "+r:r)},e};if("undefined"!=typeof module)module.exports=n;else{if("undefined"==typeof window)throw new Error("Couldn't find a suitable scope in which to define compoundSubject");window.compoundSubject=n}}();
},{}],"oFXs":[function(require,module,exports) {
var r=require("./is-string"),e=require("./is-object"),t=Array.isArray;function i(i){if(r(i)||t(i))return 0===i.length;if(e(i)){for(var n in i)return!1;return!0}throw new TypeError("Val must be a string, array or object")}module.exports=i;
},{"./is-string":"rJ7z","./is-object":"BgQ6"}],"dVQ/":[function(require,module,exports) {
var r=require("compound-subject"),e=require("101/is-empty"),n=require("101/is-string"),t=require("101/is-function"),i=require("./assert-type"),s=require("./is-class.js"),a=require("./validate.js"),o=require("./starts-with-vowel.js");function u(u,c,m){var f='"'+u+'" must be ';i(!e(m),'"validators" cannot be empty');var p=m.map(function(r){if(n(r))return r;if(s(r))return'"'+r.name+'"';if(t(r))return'pass "'+(r.name||"anonymous")+'"';throw new TypeError('"validators" must be an array containing only strings, classes, or functions')}),y=r(p).endWith("or").make();if(f+=(o(y)?"an":"a")+" "+y,!m.some(function(r){try{return a(u,c,r),!0}catch(e){return!1}}))throw new TypeError(f)}module.exports=u;
},{"compound-subject":"+Sjf","101/is-empty":"oFXs","101/is-string":"rJ7z","101/is-function":"AhE4","./assert-type":"1RSN","./is-class.js":"3HQQ","./validate.js":"N3y7","./starts-with-vowel.js":"FM5k"}],"N3y7":[function(require,module,exports) {
var e=require("101/is-function"),r=require("101/is-integer"),s=require("101/is-object"),i=require("101/is-string"),t=require("./assert-type.js"),n=require("./is-class.js"),a=function(){},u=require("./starts-with-vowel.js"),o={string:String,number:Number,array:Array,regexp:RegExp};function c(c,f,m,g){if("*"!==m){var b,l,q,y,j,p='"'+c+'"';if(Array.isArray(m))return require("./multi-validate.js")(c,f,m);if(i(m))q=o[b=m]||a,l=u(b)?"an":"a",y=g?p+" must be "+b+"s":p+" must be "+l+" "+b,j="integer"===b?r(f):"object"===b?s(f):f instanceof q||typeof f===m,t(j,y);else if(n(m))b=m.name,t(f instanceof(q=m),y=g?p+' must be instances of "'+b+'"':p+' must be an instance of "'+b+'"');else{if(!e(m))throw new TypeError('"validator" must be a string, class or function');try{m(f)}catch(v){throw v.message=p+=": "+v.message,v}}}}module.exports=c;
},{"101/is-function":"AhE4","101/is-integer":"tq8x","101/is-object":"BgQ6","101/is-string":"rJ7z","./assert-type.js":"1RSN","./is-class.js":"3HQQ","./starts-with-vowel.js":"FM5k","./multi-validate.js":"dVQ/"}],"AnOV":[function(require,module,exports) {
var e=require("debug")("assert-args"),r=require("101/exists"),t=require("101/is-object"),i=require("101/not"),s=require("./lib/is-optional-key.js"),a=require("./lib/is-spread-key.js"),l=require("./lib/validate.js"),n=i(s);function o(i,o){if("object"!=typeof i||!r(i.length))throw new TypeError('"args" must be an array or array-like object (arguments)');if(!t(o))throw new TypeError('"validation" must be an object');var h,f,u=Array.prototype.slice.call(i),g={},d=Object.keys(o);if(d.filter(a).length>1)throw new Error("assert-args only supports a single spread argument");if(d.forEach(function(t,i){var c,p=o[t],y=u[0];if(a(t)){e("is spread key: "+t),e("argKeys.length",d.length),e("argsLeft.length",u.length);var v=d.slice(i+1).filter(n);if(e("requiredKeysLeft",v),c=u.slice(0,u.length-v.length),e("spreadArgs",c),e("spreadArgs.length",c.length),s(t))e("is optional spread key: "+t),f=t.slice(4,-1),g[f]=[],c.forEach(function(i){if(!r(i))return h=null,void u.shift();try{l(t.slice(1,-1),i,p,!0),h=null,g[f].push(i),u.shift()}catch(s){if(e("spread validate err: "+s.message),e("spread validate argsLeft: "+u),h)throw h;h=s}});else{if(e("is required spread key: "+t),f=t.slice(3),g[f]=[],0===c.length)throw new TypeError('"'+t+'" is required');c.forEach(function(r){try{l(t,r,p,!0),h=null,g[f].push(r),u.shift()}catch(s){if(e("spread validate err: "+s.message),e("spread validate argsLeft: "+u),e("spread validate argKeys: "+d),i===d.length-1)throw h&&u.length-1>v.length?h:s;if(h)throw h;h=s}})}}else if(s(t))if(e("is optional key: "+t),t=t.slice(1,-1),0!==u.length){if(!r(y))return h=null,void(g[t]=u.shift());try{return l(t,y,p),h=null,void(g[t]=u.shift())}catch(w){return h=h||w,void(g[t]=void 0)}}else g[t]=void 0;else{if(e("is required key: "+t),0===u.length)throw new TypeError('"'+t+'" is required');try{l(t,y,p),h=null,g[t]=u.shift()}catch(w){if(h&&u.length>1)throw h;throw w}}}),h)throw h;return g}module.exports=o;
},{"debug":"jcLW","101/exists":"L0+K","101/is-object":"BgQ6","101/not":"bLWM","./lib/is-optional-key.js":"uDbN","./lib/is-spread-key.js":"Ddvm","./lib/validate.js":"N3y7"}],"0GGf":[function(require,module,exports) {
var r="~",n="\\x"+("0"+r.charCodeAt(0).toString(16)).slice(-2),e="\\"+n,t=new RegExp(n,"g"),i=new RegExp(e,"g"),c=new RegExp("(?:^|([^\\\\]))"+e),a=[].indexOf||function(r){for(var n=this.length;n--&&this[n]!==r;);return n},o=String;function l(i,c,o){var l,s,u=!1,f=!!c,p=[],h=[i],g=[i],v=[o?r:"[Circular]"],y=i,x=1;return f&&(s="object"==typeof c?function(r,n){return""!==r&&c.indexOf(r)<0?void 0:n}:c),function(i,c){return f&&(c=s.call(this,i,c)),u?(y!==this&&(l=x-a.call(h,this)-1,x-=l,h.splice(x,h.length),p.splice(x-1,p.length),y=this),"object"==typeof c&&c?(a.call(h,c)<0&&h.push(y=c),x=h.length,(l=a.call(g,c))<0?(l=g.push(c)-1,o?(p.push((""+i).replace(t,n)),v[l]=r+p.join(r)):v[l]=v[0]):c=v[l]):"string"==typeof c&&o&&(c=c.replace(n,e).replace(r,n))):u=!0,c}}function s(n,e){for(var t=0,c=e.length;t<c;n=n[e[t++].replace(i,r)]);return n}function u(t){return function(i,a){var l="string"==typeof a;return l&&a.charAt(0)===r?new o(a.slice(1)):(""===i&&(a=h(a,a,{})),l&&(a=a.replace(c,"$1"+r).replace(e,n)),t?t.call(this,i,a):a)}}function f(r,n,e){for(var t=0,i=n.length;t<i;t++)n[t]=h(r,n[t],e);return n}function p(r,n,e){for(var t in n)n.hasOwnProperty(t)&&(n[t]=h(r,n[t],e));return n}function h(n,e,t){return e instanceof Array?f(n,e,t):e instanceof o?e.length?t.hasOwnProperty(e)?t[e]:t[e]=s(n,e.split(r)):n:e instanceof Object?p(n,e,t):e}var g={stringify:function(r,n,e,t){return g.parser.stringify(r,l(r,n,!t),e)},parse:function(r,n){return g.parser.parse(r,u(n))},parser:JSON};module.exports=g;
...
},{"base64-js":"yh9p","ieee754":"JgNJ","isarray":"REa7","buffer":"dskh"}],"ULuE":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
var e=require("buffer").Buffer;Object.defineProperty(exports,"__esModule",{value:!0});var t=require("babel-runtime/core-js/object/keys"),r=M(t),n=require("babel-runtime/regenerator"),u=M(n),o=require("babel-runtime/helpers/asyncToGenerator"),i=M(o),a=require("babel-runtime/core-js/json/stringify"),s=M(a),c=require("babel-runtime/core-js/promise"),l=M(c),f=require("babel-runtime/helpers/typeof"),d=M(f),p=require("babel-runtime/core-js/object/get-prototype-of"),m=M(p),h=require("babel-runtime/helpers/classCallCheck"),b=M(h),v=require("babel-runtime/helpers/createClass"),y=M(v),_=require("babel-runtime/helpers/possibleConstructorReturn"),k=M(_),q=require("babel-runtime/helpers/inherits"),g=M(q),w=require("assert-args"),j=M(w),x=require("eventemitter3"),A=M(x),E=require("circular-json"),C=M(E);function M(e){return e&&e.__esModule?e:{default:e}}exports.default=function(t){return function(n){function o(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"ws://localhost:8080",t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=t.autoconnect,n=void 0===r||r,u=t.reconnect,i=void 0===u||u,a=t.reconnect_interval,s=void 0===a?1e3:a,c=t.max_reconnects,l=void 0===c?5:c,f=arguments[2];(0,b.default)(this,o);var d=(0,k.default)(this,(o.__proto__||(0,m.default)(o)).call(this));return d.queue={},d.rpc_id=0,d.address=e,d.options=arguments[1],d.autoconnect=n,d.ready=!1,d.reconnect=i,d.reconnect_interval=s,d.max_reconnects=l,d.current_reconnects=0,d.generate_request_id=f||function(){return++d.rpc_id},d.autoconnect&&d._connect(d.address,d.options),d}return(0,g.default)(o,n),(0,y.default)(o,[{key:"connect",value:function(){this.socket||this._connect(this.address,this.options)}},{key:"call",value:function(e,t,r,n){var u=this;return(0,j.default)(arguments,{method:"string","[params]":["object",Array],"[timeout]":"number","[ws_opts]":"object"}),n||"object"!==(void 0===r?"undefined":(0,d.default)(r))||(n=r,r=null),new l.default(function(o,i){if(!u.ready)return i(new Error("socket not ready"));var a=u.generate_request_id(e,t),c={jsonrpc:"2.0",method:e,params:t||null,id:a};u.socket.send((0,s.default)(c),n,function(e){if(e)return i(e);u.queue[a]={promise:[o,i]},r&&(u.queue[a].timeout=setTimeout(function(){u.queue[a]=null,i(new Error("reply timeout"))},r))})})}},{key:"listMethods",value:function(){var e=(0,i.default)(u.default.mark(function e(){return u.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,this.call("__listMethods");case 2:return e.abrupt("return",e.sent);case 3:case"end":return e.stop()}},e,this)}));return function(){return e.apply(this,arguments)}}()},{key:"notify",value:function(e,t){var r=this;return(0,j.default)(arguments,{method:"string","[params]":["object",Array]}),new l.default(function(n,u){if(!r.ready)return u(new Error("socket not ready"));var o={jsonrpc:"2.0",method:e,params:t||null};r.socket.send((0,s.default)(o),function(e){if(e)return u(e);n()})})}},{key:"subscribe",value:function(){var e=(0,i.default)(u.default.mark(function e(t){var r,n=arguments;return u.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return(0,j.default)(n,{event:["string",Array]}),"string"==typeof t&&(t=[t]),e.next=4,this.call("rpc.on",t);case 4:if(r=e.sent,"string"!=typeof t||"ok"===r[t]){e.next=7;break}throw new Error("Failed subscribing to an event '"+t+"' with: "+r[t]);case 7:return e.abrupt("return",r);case 8:case"end":return e.stop()}},e,this)}));return function(t){return e.apply(this,arguments)}}()},{key:"unsubscribe",value:function(){var e=(0,i.default)(u.default.mark(function e(t){var r,n=arguments;return u.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return(0,j.default)(n,{event:["string",Array]}),"string"==typeof t&&(t=[t]),e.next=4,this.call("rpc.off",t);case 4:if(r=e.sent,"string"!=typeof t||"ok"===r[t]){e.next=7;break}throw new Error("Failed unsubscribing from an event with: "+r);case 7:return e.abrupt("return",r);case 8:case"end":return e.stop()}},e,this)}));return function(t){return e.apply(this,arguments)}}()},{key:"close",value:function(e,t){this.socket.close(e||1e3,t)}},{key:"_connect",value:function(n,u){var o=this;this.socket=new t(n,u),this.socket.on("open",function(){o.ready=!0,o.emit("open"),o.current_reconnects=0}),this.socket.on("message",function(t){t instanceof ArrayBuffer&&(t=e.from(t).toString());try{t=C.default.parse(t)}catch(i){return}if(t.notification&&o.listeners(t.notification).length){if(!(0,r.default)(t.params).length)return o.emit(t.notification);var n=[t.notification];if(t.params.constructor===Object)n.push(t.params);else for(var u=0;u<t.params.length;u++)n.push(t.params[u]);return o.emit.apply(o,n)}if(!o.queue[t.id])return t.method&&t.params?o.emit(t.method,t.params):void 0;o.queue[t.id].timeout&&clearTimeout(o.queue[t.id].timeout),t.error?o.queue[t.id].promise[1](t.error):o.queue[t.id].promise[0](t.result),o.queue[t.id]=null}),this.socket.on("error",function(e){return o.emit("error",e)}),this.socket.on("close",function(e,t){o.ready&&o.emit("close",e,t),o.ready=!1,1e3!==e&&(o.current_reconnects++,o.reconnect&&(o.max_reconnects>o.current_reconnects||0===o.max_reconnects)&&setTimeout(function(){return o._connect(n,u)},o.reconnect_interval))})}}]),o}(A.default)},module.exports=exports.default;
},{"babel-runtime/core-js/object/keys":"8FtN","babel-runtime/regenerator":"aIIw","babel-runtime/helpers/asyncToGenerator":"kcQR","babel-runtime/core-js/json/stringify":"HxWs","babel-runtime/core-js/promise":"L3Vt","babel-runtime/helpers/typeof":"GyB/","babel-runtime/core-js/object/get-prototype-of":"BX4+","babel-runtime/helpers/classCallCheck":"dACh","babel-runtime/helpers/createClass":"jx4H","babel-runtime/helpers/possibleConstructorReturn":"VOrx","babel-runtime/helpers/inherits":"ZKjc","assert-args":"AnOV","eventemitter3":"2JJl","circular-json":"0GGf","buffer":"dskh"}],"TjgW":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Client=void 0;var e=require("./lib/client/websocket.browser"),t=l(e),r=require("./lib/client"),i=l(r);function l(e){return e&&e.__esModule?e:{default:e}}var u=exports.Client=(0,i.default)(t.default);
},{"./lib/client/websocket.browser":"ScGw","./lib/client":"ULuE"}],"7QCb":[function(require,module,exports) {
"use strict";var e=t(require("@babel/runtime/regenerator")),n=t(require("@babel/runtime/helpers/asyncToGenerator"));function t(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var r=require("rpc-websockets"),o="/_dna_connections.json";function c(){return fetch(o).then(function(e){return e.json()}).then(function(e){return e.dna_interface.driver.port}).then(function(e){return"ws://localhost:".concat(e)})}exports.connect=function(t){return new Promise(function(){var o=(0,n.default)(e.default.mark(function n(o,u){var a,i;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(e.t0=t,e.t0){e.next=5;break}return e.next=4,c().catch(function(){return u("Could not auto-detect DNA interface from conductor. Ensure the web UI is hosted by a Holochain Conductor or manually specify url as parameter to connect")});case 4:e.t0=e.sent;case 5:a=e.t0,(i=new r.Client(a)).on("open",function(){o({call:function(){for(var e=arguments.length,n=new Array(e),t=0;t<e;t++)n[t]=arguments[t];return function(e){var t=1===n.length?n[0]:n.join("/");return i.call(t,e)}},close:function(){return i.close()},ws:i})});case 8:case"end":return e.stop()}},n,this)}));return function(e,n){return o.apply(this,arguments)}}())};var u={connect:exports.connect};
},{"@babel/runtime/regenerator":"PMvg","@babel/runtime/helpers/asyncToGenerator":"agGE","rpc-websockets":"TjgW"}]},{},["7QCb"], "holochainclient")
//# sourceMappingURL=/hc-web-client-0.1.2.browser.min.map